...
(function (t) {
    ...
    var e, i, s, n, r, a = t.GreenSockGlobals || t, o = function (t) {
        ...
        this.check = function (l) {
            for (var h, _, p, f, c = i.length, d = c; --c > -1;)(h = u[i[c]] || new m(i[c], [])).gsClass ? (r[c] = h.gsClass, d--) : l && h.sc.push(this);
            if (0 === d && s)for (_ = ("com.greensock." + e).split("."), p = _.pop(), f = o(_.join("."))[p] = this.gsClass = s.apply(s, r), n && (a[p] = f, "function" == typeof define && define.amd ? define((t.GreenSockAMDPath ? t.GreenSockAMDPath + "/" : "") + e.split(".").join("/"), [], function () {
                return f
            }) : "undefined" != typeof module && module.exports && (module.exports = f)), c = 0; this.sc.length > c; c++)this.sc[c].check()
        }, this.check(!0)
    ...
    var c = [0, 0, 1, 1], d = [], v = f("easing.Ease", function (t, e, i, s) {
        ...
        for (var n, r, a, o, h = e.split(","), _ = h.length, u = (i || "easeIn,easeOut,easeInOut").split(","); --_ > -1;)for (r = h[_], n = s ? f("easing." + r, null, !0) : l.easing[r] || {}, a = u.length; --a > -1;)o = u[a], g[r + "." + o] = g[o + r] = n[o] = t.getRatio ? t : t[o] || new t
    };
    ...
    for (e = ["ms", "moz", "webkit", "o"], i = e.length; --i > -1 && !w;)w = t[e[i] + "RequestAnimationFrame"], y = t[e[i] + "CancelAnimationFrame"] || t[e[i] + "CancelRequestAnimationFrame"];
    ...
    n = b.ticker = new l.Ticker, s = b.prototype, s._dirty = s._gc = s._initted = s._paused = !1, s._totalTime = s._time = 0, s._rawPrevTime = -1, s._next = s._last = s._onUpdate = s._timeline = s.timeline = null, s._paused = !1, s.play = function (t, e) {
        ...
        if ("on" === t.substr(0, 2)) {
            ...
            if (null == e)delete r[t]; else if (r[t] = e, r[t + "Params"] = i, r[t + "Scope"] = s, i)for (n = i.length; --n > -1;)"{self}" === i[n] && (i = r[t + "Params"] = i.concat(), i[n] = this);
        ...
        if (this._timeline) {
            if (0 > t && !i && (t += this.totalDuration()), this._timeline.smoothChildTiming) {
                ...
                if (t > s && !i && (t = s), this._startTime = (this._paused ? this._pauseTime : a._time) - (this._reversed ? s - t : t) / this._timeScale, a._dirty || this._uncache(!1), !a._active)for (; a._timeline;)a.totalTime(a._totalTime, !0), a = a._timeline
            }
    ...
    var S = f("TweenLite", function (t, e, i) {
        ...
        var i, s = {};
        for (i in t)O[i] || i in e && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i || !(!D[i] || D[i] && D[i]._autoCSS) || (s[i] = t[i], delete t[i]);
        t.css = s
    };
    ...
    var R = S._internals = {}, D = S._plugins = {}, E = S._tweenLookup = {}, I = 0, O = R.reservedProps = {
        ease: 1,
        delay: 1,
        overwrite: 1,
        onComplete: 1,
        ...
        "true": 1,
        "false": 0
    }, U = b._rootFramesTimeline = new A, L = b._rootTimeline = new A;
    ...
    var F = function (t, e, i) {
        ...
        for (r = n.length; --r > -1;)(o = n[r]) === e || o._gc || o._paused || (o._timeline !== e._timeline ? (h = h || Q(e, 0, p), 0 === Q(o, h, p) && (u[m++] = o)) : _ >= o._startTime && o._startTime + o.totalDuration() / o._timeScale + 1e-10 > _ && ((p || !o._initted) && 2e-10 >= _ - o._startTime || (u[m++] = o)));
    ...
    s._init = function () {
        ...
        if (n.startAt) {
            if (n.startAt.overwrite = 0, n.startAt.immediateRender = !0, this._startAt = S.to(this.target, 0, n.startAt), n.immediateRender && (this._startAt = null, 0 === this._time && 0 !== a))return
        } else if (n.runBackwards && n.immediateRender && 0 !== a)if (this._startAt)this._startAt.render(-1, !0), this._startAt = null; else if (0 === this._time) {
            i = {};
            for (s in n)O[s] && "autoCSS" !== s || (i[s] = n[s]);
            return i.overwrite = 0, this._startAt = S.to(this.target, 0, i), void 0
        }
        if (this._ease = o ? o instanceof v ? n.easeParams instanceof Array ? o.config.apply(o, n.easeParams) : o : "function" == typeof o ? new v(o, n.easeParams) : g[o] || S.defaultEase : S.defaultEase, this._easeType = this._ease._type, this._easePower = this._ease._power, this._firstPT = null, this._targets)for (t = this._targets.length; --t > -1;)this._initProps(this._targets[t], this._propLookup[t] = {}, this._siblings[t], r ? r[t] : null) && (e = !0); else e = this._initProps(this.target, this._propLookup, this._siblings, r);
        if (e && S._onPluginEvent("_onInitAllProps", this), r && (this._firstPT || "function" != typeof this.target && this._enabled(!1, !1)), n.runBackwards)for (i = this._firstPT; i;)i.s += i.c, i.c = -i.c, i = i._next;
        ...
        for (n in this.vars) {
            if (O[n]) {
                if (("onStartParams" === n || "onUpdateParams" === n || "onCompleteParams" === n || "onReverseCompleteParams" === n || "onRepeatParams" === n) && (l = this.vars[n]))for (r = l.length; --r > -1;)"{self}" === l[r] && (l = this.vars[n] = l.concat(), l[r] = this)
                ...
                for (this._firstPT = h = {
                    ...
                    pg: !0,
                    pr: o._priority
                }, r = o._overwriteProps.length; --r > -1;)e[o._overwriteProps[r]] = this._firstPT;
                (o._priority || o._onInitAllProps) && (a = !0), (o._onDisable || o._onEnable) && (this._notifyPluginsOfEnabled = !0)
            } else this._firstPT = e[n] = h = {
                _next: this._firstPT,
                t: t,
                p: n,
                ...
                pg: !1,
                pr: 0
            }, h.s = h.f ? t[n.indexOf("set") || "function" != typeof t["get" + n.substr(3)] ? n : "get" + n.substr(3)]() : parseFloat(t[n]), _ = this.vars[n], h.c = "string" == typeof _ && "=" === _.charAt(1) ? parseInt(_.charAt(0) + "1", 10) * Number(_.substr(2)) : Number(_) - h.s || 0;
        ...
        if (t >= this._duration)this._totalTime = this._time = this._duration, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1, this._reversed || (s = !0, n = "onComplete"), 0 === this._duration && ((0 === t || 0 > this._rawPrevTime) && this._rawPrevTime !== t && (i = !0, this._rawPrevTime > 0 && (n = "onReverseComplete", e && (t = -1))), this._rawPrevTime = t); else if (1e-7 > t)this._totalTime = this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== a || 0 === this._duration && this._rawPrevTime > 0) && (n = "onReverseComplete", s = this._reversed), 0 > t ? (this._active = !1, 0 === this._duration && (this._rawPrevTime >= 0 && (i = !0), this._rawPrevTime = t)) : this._initted || (i = !0); else if (this._totalTime = this._time = t, this._easeType) {
        ...
        if (this._time !== a || i) {
            ...
            for (this._active || this._paused || (this._active = !0), 0 === a && (this._startAt && (t >= 0 ? this._startAt.render(t, e, i) : n || (n = "_dummyGS")), this.vars.onStart && (0 !== this._time || 0 === this._duration) && (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || d))), r = this._firstPT; r;)r.f ? r.t[r.p](r.c * this.ratio + r.s) : r.t[r.p] = r.c * this.ratio + r.s, r = r._next;
    ...
    if (s = j.prototype, j.version = "1.9.1", j.API = 2, s._firstPT = null, s._addTween = function (t, e, i, s, n, r) {
            ...
            for (var e = t.length; --e > -1;)t[e].API === j.API && (D[(new t[e])._propName] = t[e]);
            return !0
        }, p.plugin = function (t) {
...
(window._gsQueue || (window._gsQueue = [])).push(function () {
    ...
    window._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function (t, e) {
        ...
        h.constructor = a, a.version = "1.9.8", a.API = 2, a.defaultTransformPerspective = 0, h = "px", a.suffixMap = {
            top: h,
            right: h,
            bottom: h,
            left: h,
        ...
        var ve = "scaleX,scaleY,scaleZ,x,y,z,skewX,rotation,rotationX,rotationY,perspective".split(","), ye = q("transform"), Te = j + "transform", we = q("transformOrigin"), xe = null !== q("perspective"), be = function (t, e, i, s) {
            ...
            for (ye ? r = Z(t, Te, e, !0) : t.currentStyle && (r = t.currentStyle.filter.match(A), r = r && 4 === r.length ? [r[0].substr(4), Number(r[2].substr(4)), Number(r[1].substr(4)), r[3].substr(4), v.x || 0, v.y || 0].join(",") : ""), n = (r || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], o = n.length; --o > -1;)h = Number(n[o]), n[o] = (l = h - (h |= 0)) ? (0 | l * w + (0 > l ? -.5 : .5)) / w + h : h;
            if (16 === n.length) {
            ...
            if (p && (a = u.top ? "top" : u.bottom ? "bottom" : parseFloat(Z(this.t, "top", null, !1)) ? "bottom" : "top", i = Z(this.t, a, null, !1), o = parseFloat(i) || 0, h = i.substr((o + "").length) || "px", l._ffFix = !l._ffFix, u[a] = (l._ffFix ? o + .05 : o - .05) + h), C || l.skewX)i = f * Math.cos(C), s = v * Math.sin(C), C -= l.skewX, c = f * -Math.sin(C), v *= Math.cos(C), f = i, g = s; else if (!l.rotationY && !l.rotationX && 1 === b)return u[ye] = "translate3d(" + l.x + "px," + l.y + "px," + l.z + "px)" + (1 !== f || 1 !== v ? " scale(" + f + "," + v + ")" : ""), void 0;
        ...
        de("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform", {
            ...
            defaultValue: "0 0", parser: function (t, e, i, s, n, a) {
                ...
                if (-1 !== d.indexOf("%") != (-1 !== g.indexOf("%")) && (p = Z(t, "backgroundImage").replace(R, ""), p && "none" !== p)) {
                    for (o = d.split(" "), h = g.split(" "), X.setAttribute("src", p), l = 2; --l > -1;)d = o[l], u = -1 !== d.indexOf("%"), u !== (-1 !== h[l].indexOf("%")) && (_ = 0 === l ? t.offsetWidth - X.width : t.offsetHeight - X.height, o[l] = u ? parseFloat(d) / 100 * _ + "px" : 100 * (parseFloat(d) / _) + "%");
                    d = o.join(" ")
                }
...
(window._gsQueue || (window._gsQueue = [])).push(function () {
    ...
    window._gsDefine("plugins.CSSRulePlugin", ["plugins.TweenPlugin", "TweenLite", "plugins.CSSPlugin"], function (t, e, i) {
        ...
        return a._propName = "cssRule", a.constructor = s, s.API = 2, s.getRule = function (t) {
            var e, i, s, n, a = r.all ? "rules" : "cssRules", o = r.styleSheets, h = o.length, l = ":" === t.charAt(0);
            for (t = (l ? "" : ",") + t.toLowerCase() + ",", l && (n = []); --h > -1;)for (i = o[h][a], e = i.length; --e > -1;)if (s = i[e], s.selectorText && -1 !== ("," + s.selectorText.split("::").join(":").toLowerCase() + ",").indexOf(t)) {
                if (!l)return s.style;
                n.push(s.style)
            }
            return n
